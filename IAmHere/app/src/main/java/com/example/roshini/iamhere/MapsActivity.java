package com.example.roshini.iamhere;
...
import com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener;import com.google.android.gms.maps.CameraUpdateFactory;
...
///////////////////////////////////////////////////////////////////
            ...
            for (int i = 0; i < v.size(); i++){
                String latText = v.get(i).latitude + "";
                String longText = v.get(i).longitude + "";
                mMap.addMarker(new MarkerOptions().position(v.get(i)).title(latText +" , "+ longText));
            }
